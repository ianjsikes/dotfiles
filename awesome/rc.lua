...
-- local brightness    = require("redflat.float.brightness")
local brightness    = require("dsk.brightness")
local volume        = require("dsk.volume")
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ modkey }, "Up", function() brightness:change_with_xbacklight{step=10} end),
    -- awful.key({ modkey }, "Down", function() brightness:change_with_xbacklight{step=10,down=true} end),
